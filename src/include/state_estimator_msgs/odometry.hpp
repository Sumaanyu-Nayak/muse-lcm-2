...
#include "pose_with_covariance_t.hpp"
#include "twist_with_covariance_t.hpp"
...
class odometry
{
    public:
        ...
        pose_with_covariance_t pose;

        twist_with_covariance_t twist;
...
uint64_t odometry::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0xa5178b0ba8c05e3cLL +
         header_t::_computeHash(&cp) +
         pose_with_covariance_t::_computeHash(&cp) +
         twist_with_covariance_t::_computeHash(&cp);
